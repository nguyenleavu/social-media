...
postsRouter.get('/:post_id', users_middlewares_1.accessTokenValidator, posts_middlewares_1.postIdValidator, (0, users_middlewares_1.isUserLoggedInValidator)(users_middlewares_1.accessTokenValidator), (0, users_middlewares_1.isUserLoggedInValidator)(users_middlewares_1.verifiedUserValidator), posts_middlewares_1.audienceValidator, (0, handlers_1.wrapRequestHandler)(posts_controller_1.getPostController));
